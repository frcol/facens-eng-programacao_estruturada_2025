...
typedef struct hospede{
        int  *num_quarto;	//aponta para o nº do quarto
        char nome[30];
        int  acompanhante;
        int  dias;
        }hospede;
...
do{
  ...
  switch(op)
    {
    case 1: pos=busca_vago(ph,cont);  //procurar quarto=-1
...
if(ind==-1)
  ...
  {
  h->num_quarto=&((q+ind)->num);   //recebe o endereço
